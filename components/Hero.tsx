export default function Hero() {
  return (
    <section className="relative isolate bg-[#FAFAFA] pb-24 pt-8 md:pt-16">
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute left-1/2 top-6 h-52 w-52 -translate-x-1/2 rounded-full bg-[#128C7E]/10 blur-3xl" />
      </div>

      <div className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-8 px-4 sm:px-6 lg:grid-cols-2 lg:items-center lg:gap-12 lg:px-8">
        <div>
          ...
          <p className="mt-4 text-sm font-medium text-[#667085]">Fast setup. Clear pricing. Real business growth.</p>
        </div>
