...
const plans = [
  {
    ...
    copy: "Best for businesses that want a proper online presence with the basics done right.",
  ...
  },
  {
    ...
    copy: "This is the plan for owners who want visibility, branding, and regular customer enquiries.",
  ...
  },
  {
    ...
    copy: "For businesses that want full digital handling, automation, maintenance, and priority support.",
